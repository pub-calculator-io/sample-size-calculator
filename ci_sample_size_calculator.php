...
Version: 1.0.0
Author: Sample Size Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Sample Size Calculator by www.calculator.io";

function display_calcio_ci_sample_size_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_sample_size_calculator', 'display_calcio_ci_sample_size_calculator' );