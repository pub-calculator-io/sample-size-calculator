<?php
/*
Plugin Name: Sample Size Calculator by Calculator.iO
...
function display_ci_sample_size_calculator(){
    $page = 'index.html';
    return '<h2><a href="https://www.calculator.io/sample-size-calculator/" target="_blank"><img src="' . esc_url(plugins_url('assets/images/icon-48.png', __FILE__ )) . '" width="48" height="48"></a> Sample Size Calculator</h2><div><iframe style="background:transparent; overflow: scroll" src="' . esc_url(plugins_url($page, __FILE__ )) . '" width="100%" frameBorder="0" allowtransparency="true" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + \'px\';" id="ci_sample_size_calculator_iframe"></iframe></div>';
}
